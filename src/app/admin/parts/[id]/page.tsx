      ...
      <div className="bg-white p-8 rounded-lg shadow border border-slate-200">
        <form action={savePartAction} className="space-y-6">
          ...
          <div>
            ...
            <input type="url" id="imageUrl" name="imageUrl" defaultValue={part.imageUrl || ""} className="w-full px-3 py-2 border border-slate-300 rounded focus:ring-blue-500 focus:border-blue-500" />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              name="specs"
              rows={8}
              defaultValue={JSON.stringify(part.specs, null, 2)}
