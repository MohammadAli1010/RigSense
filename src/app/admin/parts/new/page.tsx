  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold text-slate-900">Add New Part</h1>
      </div>
        ...
        <form action={savePartAction} className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" id="brand" name="brand" required className="w-full px-3 py-2 border border-slate-300 rounded focus:ring-blue-500 focus:border-blue-500" />
            </div>
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-1">Product Name</label>
              <input type="text" id="name" name="name" required className="w-full px-3 py-2 border border-slate-300 rounded focus:ring-blue-500 focus:border-blue-500" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <select id="category" name="category" required className="w-full px-3 py-2 border border-slate-300 rounded bg-white focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
              ...
              <input type="number" id="priceCents" name="priceCents" required min="0" className="w-full px-3 py-2 border border-slate-300 rounded focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. 29900 for $299.00" />
            </div>
          </div>
          ...
          <div className="flex justify-end gap-4 pt-4 border-t border-slate-100">
            ...
            <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-medium">Save Part</button>
          </div>
        </form>
      </div>
    </div>
