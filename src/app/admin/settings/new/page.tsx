  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-8 flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold text-slate-900">Add Setting</h1>
      </div>
        ...
        <form action={saveOperationalSettingAction} className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input id="key" name="key" required className="w-full rounded border border-slate-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500" placeholder="pricing.manual-fallback-enabled" />
            </div>
            <div>
              <label htmlFor="label" className="mb-1 block text-sm font-medium text-slate-700">Label</label>
              <input id="label" name="label" required className="w-full rounded border border-slate-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500" />
            </div>
          </div>
          <div>
            <label htmlFor="value" className="mb-1 block text-sm font-medium text-slate-700">Value</label>
            <input id="value" name="value" required className="w-full rounded border border-slate-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500" />
          </div>
          <div>
          ...
          <div className="flex justify-end gap-4 border-t border-slate-100 pt-4">
            ...
            <button type="submit" className="rounded bg-blue-600 px-6 py-2 font-medium text-white hover:bg-blue-700">Save Setting</button>
          </div>
        </form>
      </div>
    </div>
